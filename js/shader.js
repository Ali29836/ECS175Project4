...
class Shader
{
    ...
    use( )
    {
        ...
        var KaValue = document.getElementById('KaSlider').value
        var getKaValue = this.gl.getUniformLocation(this.program, 'Ka');
        this.gl.uniform1f(getKaValue, KaValue);

        var KdValue = document.getElementById('KdSlider').value
        var getKdValue = this.gl.getUniformLocation(this.program, 'Kd');
        this.gl.uniform1f(getKdValue, KdValue);

        var KsValue = document.getElementById('KsSlider').value
        var getKsValue = this.gl.getUniformLocation(this.program, 'Ks');
        this.gl.uniform1f(getKsValue, KsValue);
/*
        var LightIntxValue = document.getElementById('LightIntx').value
        console.log(LightIntxValue)
        var getLightIntxValue = this.gl.getUniformLocation(this.program, 'sunlightIntensity');
        this.gl.uniform1f(getLightIntxValue.x, LightIntxValue);
    

        var LightIntyValue = document.getElementById('LightInty').value
        var getLightIntyValue = this.gl.getUniformLocation(this.program, 'sunlightIntensity');
        this.gl.uniform1f(getLightIntyValue.y, LightIntyValue);

        var LightIntzValue = document.getElementById('LightIntz').value
        var getLightIntzValue = this.gl.getUniformLocation(this.program, 'sunlightIntensity');
        this.gl.uniform1f(getLightIntzValue.z, LightIntzValue);
*/
    }
